...
if sys.platform=="win32" or sys.platform=="cygwin":
    ...
    #
    libnames   = ["alglib317_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".dll"]
    targetname =  "alglib317_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".dll"
    dirname    = "bin-windows-intel"
else:
    libnames   = ["alglib317_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".so"]
    targetname = "alglib317_"+str(ctypes.sizeof(ctypes.c_void_p)*8)+"free"+".so"
