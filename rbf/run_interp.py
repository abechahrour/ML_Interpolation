...
######################################################
    ...
    print(y_transf.max())
    if n_train < 10**4:
        interpolator = RBFInterpolator(x_train, y_transf)
    else:
        print("Starting Interpolation")
        interpolator = RBFInterpolator(x_train, y_transf, neighbors = neighbors)
        #interpolator.neighbors = 50
    ...
    cm.plot_nearest(y_test, y_pred, measures, 'rbf', NAME)
