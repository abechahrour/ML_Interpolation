...
def main(argv):
    ...
    NAME = "{}_n_{}_md_{}_cw_{}_ss_{}_cs_{}_l_{}_d_{}_b_{}_lr_{}_{:.0e}".format(func, n_estimators,
            max_depth, min_child_weight, subsample, colsample_bytree, loss, ndims, booster,lr, n_train)
